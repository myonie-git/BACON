                            ...
                            for (int i5 = 0; i5 < steps; i5++) {
                                for (int i6 = 0; i6 < steps; i6++) {
                                    ...
                                    std::map<std::string, double> jointAngles = {
                                        {"joint1", start_angle + i1 * step_size},
                                        {"joint2", start_angle + i2 * step_size},
                                        {"joint3", start_angle + i3 * step_size},
                                        {"joint4", start_angle + i4 * step_size},
                                        {"joint5", start_angle + i5 * step_size},
                                        {"joint6", start_angle + i6 * step_size}
                                    };
