                            ...
                            for (int i4 = 0; i4 < steps; i4++) {
                                for (int i5 = 0; i5 < steps; i5++) {
                                    for (int i6 = 0; i6 < steps; i6++) {
                                        ...
                                        local_jointAngles["j2n6s300_joint_1"] = joint1;
                                        local_jointAngles["j2n6s300_joint_2"] = joint2;
                                        local_jointAngles["j2n6s300_joint_3"] = joint3;
                                        local_jointAngles["j2n6s300_joint_4"] = joint4;
                                        local_jointAngles["j2n6s300_joint_5"] = joint5;
                                        local_jointAngles["j2n6s300_joint_6"] = joint6;
