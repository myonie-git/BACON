...
#define NUM_TF 2
#define NUM_PARA 10
#define NUM_TREE_PARA 11
#define NUM_PARA_PARA 6
...
std::string urdfFilePath = BACON_SOURCE_DIR "/j2_prior.urdf"; 
...
int main(int argc, char *argv[]) {
    ...
    std::cout << "stage1_timer : " << stage1_timer << std::endl;
    std::cout << "stage2_timer : " << stage2_timer << std::endl;
    std::cout << "stage3_timer : " << stage3_timer << std::endl;
