                        ...
                        for (double joint4 = start_angle; joint4 <= end_angle; joint4 += step_size) {
                            for (double joint5 = start_angle; joint5 <= end_angle; joint5 += step_size) {
                                for (double joint6 = start_angle; joint6 <= end_angle; joint6 += step_size) {
                                    jointAngles["j2n6s200_joint_finger_1"] = joint1;
                                    jointAngles["j2n6s200_joint_finger_2"] = joint2;
                                    jointAngles["j2n6s200_joint_1"] = joint3;
                                    jointAngles["j2n6s200_joint_3"] = joint4;
                                    jointAngles["j2n6s200_joint_6"] = joint5;
                                    jointAngles["j2n6s200_joint_finger_tip_2"] = joint6;
