...
int main(int argc, char *argv[]) {
    ...
    int filenum = 100; 
    int thread_count = 1;
    std::string csv_output = "collision_results.csv";  // Default CSV output file
                            ...
                            for (int i5 = 0; i5 < steps; i5++) {
                                for (int i6 = 0; i6 < steps; i6++) {
                                    ...
                                    std::map<std::string, double> jointAngles = {
                                        {"j2n6s300_joint_1", start_angle + i1 * step_size},
                                        {"j2n6s300_joint_2", start_angle + i2 * step_size},
                                        {"j2n6s300_joint_3", start_angle + i3 * step_size},
                                        {"j2n6s300_joint_4", start_angle + i4 * step_size},
                                        {"j2n6s300_joint_5", start_angle + i5 * step_size},
                                        {"j2n6s300_joint_6", start_angle + i6 * step_size},
                                        {"j2n6s300_joint_finger_1", 0.0},
                                        {"j2n6s300_joint_finger_2", 0.0},
                                        {"j2n6s300_joint_finger_3", 0.0},
                                        {"j2n6s300_joint_finger_tip_1", 0.0},
                                    ...
                                    // std::cout << "Joint Angles: " << jointAngles["j2n6s300_joint_6"] << std::endl;
                                    ...
                                    // std::cout << "Joint Angles: " << (start_angle + i1 * step_size) << ", " 
                                    //           << (start_angle + i2 * step_size) << ", " << (start_angle + i3 * step_size) << ", "
                                    //           << (start_angle + i4 * step_size) << ", " << (start_angle + i5 * step_size) << ", " 
                                    //           << (start_angle + i6 * step_size)
