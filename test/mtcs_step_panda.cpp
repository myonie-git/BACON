                            ...
                            for (int i4 = 0; i4 < steps; i4++) {
                                for (int i5 = 0; i5 < steps; i5++) {
                                    for (int i6 = 0; i6 < steps; i6++) {
                                        ...
                                        local_jointAngles["panda_joint1"] = joint1;
                                        local_jointAngles["panda_joint2"] = joint2;
                                        local_jointAngles["panda_joint3"] = joint3;
                                        local_jointAngles["panda_joint4"] = joint4;
                                        local_jointAngles["panda_joint5"] = joint5;
                                        local_jointAngles["panda_joint6"] = joint6;
