                            ...
                            for (int i5 = 0; i5 < steps; i5++) {
                                for (int i6 = 0; i6 < steps; i6++) {
                                    ...
                                    std::map<std::string, double> jointAngles = {
                                        {"j2n6s200_joint_1", start_angle + i1 * step_size},
                                        {"j2n6s200_joint_2", start_angle + i2 * step_size},
                                        {"j2n6s200_joint_3", start_angle + i3 * step_size},
                                        {"j2n6s200_joint_4", start_angle + i4 * step_size},
                                        {"j2n6s200_joint_5", start_angle + i5 * step_size},
                                        {"j2n6s200_joint_6", start_angle + i6 * step_size},
