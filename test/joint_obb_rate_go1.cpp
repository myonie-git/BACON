                        ...
                        for (double joint4 = start_angle; joint4 <= end_angle; joint4 += step_size) {
                            for (double joint5 = start_angle; joint5 <= end_angle; joint5 += step_size) {
                                for (double joint6 = start_angle; joint6 <= end_angle; joint6 += step_size) {
                                    ...
                                    jointAngles["FL_thigh_joint"] = joint1;
                                    jointAngles["FR_thigh_joint"] = joint2;
                                    jointAngles["RL_thigh_joint"] = joint3;
                                    jointAngles["RR_thigh_joint"] = joint4;
                                    jointAngles["RL_calf_joint"] = joint5;
                                    jointAngles["FL_calf_joint"] = joint6;
