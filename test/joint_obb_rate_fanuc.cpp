                            ...
                            for (double joint5 = start_angle; joint5 <= end_angle; joint5 += step_size) {
                                for (double joint6 = start_angle; joint6 <= end_angle; joint6 += step_size) {
                                    ...
                                    for (int i = 0; i < model.collisionGeometries.size(); i++) {
                                        ...
                                        //     std::cout << model.collisionGeometries[i]->parentLink->position << std::endl;
                                        //     std::cout << model.collisionGeometries[i]->parentLink->rotation.toRotationMatrix() << std::endl;
                                        // }     
                                    }
                                    ...
                                    for (int i = 0; i < collision_geometry_.size() && !result; i++) {
                                        result = env.collide_obbcount(&collision_geometry_[i], nullptr, aabb_conut, obb_count);
                                        // if (result == true) {
