...
for idx, size in enumerate(obstacle_sizes):
    ...
    ax.set_ylabel('Throughput', size=20, fontdict=font_options)
...
fig.text(0.04, 0.5, "Throughput", va='center', rotation='vertical', fontsize=25, fontdict=font_options)
...
# 保存图像为PDF
output_image = "strategy_throughput.pdf"
