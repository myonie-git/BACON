...
# 定义测试脚本列表
test_scripts = [
    f"{BACON_REPO_ROOT}/build/openmp_sim_cpu_fanuc --t 12",
    f"{BACON_REPO_ROOT}/build/openmp_sim_cpu_prbt --t 12",
    f"{BACON_REPO_ROOT}/build/openmp_sim_cpu_panda --t 12",
    f"{BACON_REPO_ROOT}/build/openmp_sim_cpu_jaco2 --t 12",
    f"{BACON_REPO_ROOT}/build/openmp_sim_cpu_jaco3 --t 12",
    f"{BACON_REPO_ROOT}/build/openmp_sim_cpu_go1 --t 12",
