...
def generate_tables(base_dir='data'):
    ...
    # 将结果保存为 CSV 文件
    df_env.to_csv('obb_env_counts.csv')
    df_no.to_csv('obb_no_counts.csv')
    print("\n统计结果已保存为 'obb_env_counts.csv' 和 'obb_no_counts.csv'。")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '-d', '--directory',
        type=str,
        default=f'{BACON_REPO_ROOT}/exp/collision_rate_obb',
