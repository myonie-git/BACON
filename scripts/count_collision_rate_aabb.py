...
def generate_tables(base_dir='data'):
    ...
    # 将结果保存为 CSV 文件
    df_env.to_csv('aabb_env_counts.csv')
    df_no.to_csv('aabb_no_counts.csv')
    print("\n统计结果已保存为 'aabb_env_counts.csv' 和 'aabb_no_counts.csv'。")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '-d', '--directory',
        type=str,
        default=f'{BACON_REPO_ROOT}/exp/collision_rate_aabb',
