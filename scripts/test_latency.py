...
test_scripts = [
    ...
    # f"{BACON_REPO_ROOT}/build/sim_gpu_latency_fanuc",
    # f"{BACON_REPO_ROOT}/build/sim_gpu_latency_prbt",
    # f"{BACON_REPO_ROOT}/build/sim_gpu_latency_panda",
    # f"{BACON_REPO_ROOT}/build/sim_gpu_latency_jaco2",
    # f"{BACON_REPO_ROOT}/build/sim_gpu_latency_jaco3",
    # f"{BACON_REPO_ROOT}/build/sim_gpu_latency_go1",
