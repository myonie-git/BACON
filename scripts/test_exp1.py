...
test_scripts = [
    ...
    f"{BACON_REPO_ROOT}/build/sim_timer_fanuc",
    f"{BACON_REPO_ROOT}/build/sim_timer_prbt",
    f"{BACON_REPO_ROOT}/build/sim_timer_panda",
    f"{BACON_REPO_ROOT}/build/sim_timer_jaco2",
    f"{BACON_REPO_ROOT}/build/sim_timer_jaco3",
    f"{BACON_REPO_ROOT}/build/sim_timer_go1",
]
...
# 输出文件
output_file = "formatted_execution_times.csv"
error_log = "formatted_execution_errors.log"
