...
test_scripts = [
    ...
    f"{BACON_REPO_ROOT}/build/sim_group_timer_fanuc --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_prbt --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_panda --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_jaco2 --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_jaco3 --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_go1 --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_fanuc --s --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_prbt --s --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_panda --s --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_jaco2 --s --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_jaco3 --s --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_go1 --s --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_fanuc --p --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_prbt --p --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_panda --p --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_jaco2 --p --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_jaco3 --p --t",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_go1 --p --t",
]
...
# 输出文件
output_file = "group_throughput.csv"
error_log = "group_throughput.log"
