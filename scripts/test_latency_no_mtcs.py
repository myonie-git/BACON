...
test_scripts = [
    ...
    f"{BACON_REPO_ROOT}/build/sim_group_timer_fanuc_no_mtcs --g",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_prbt_no_mtcs --g",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_panda_no_mtcs --g",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_jaco2_no_mtcs --g",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_jaco3_no_mtcs --g",
    f"{BACON_REPO_ROOT}/build/sim_group_timer_go1_no_mtcs --g",
]
...
# 输出文件
output_file = "latency_no_mtcs.csv"
error_log = "latency_no_mtcs.log"
...
for script in test_scripts:
    ...
    for directory in directories:
        ...
        # 初始化存储结构
        if key not in data:
            data[key] = {"NO_MTCS": "N/A", "TIMER": "N/A"}
